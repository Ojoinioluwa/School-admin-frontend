      ...
      <div className="scroll w-full h-[85vh] rounded-lg overflow-y-scroll scroll-smooth">
        ...
        <ul className="w-full h-full  ">
          ...
          {teachersResponse.teachers.map((teacher)=> (
            <li key={teacher._id} className="border-t border-gray-500 flex justify-around items-center p-4 hover:bg-purple-200 cursor-pointer">
              <input type="checkbox" />
            ...
            <div className="w-[10%]  text-wrap">{teacher.subjectsAssigned[0] || "Nil"}</div>
            <div className="w-[10%] ">Actions</div>
            </li>
          ))}
        </ul>
